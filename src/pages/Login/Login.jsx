...
import {AiFillContacts, AiOutlineContacts, AiOutlineEye} from 'react-icons/ai'
...
const Login = () => {
  ...
  return (
        ...
        <section className='flex justify-center mt-20 items-center'>
          <aside className='bg-slate-50 font-sans p-6 rounded-xl shadow-lg'>
            <header className='font-extrabold text-2xl text-center text-slate-700'>Sign In</header>
            <div className='flex flex-row'>
            <NavLink to={'/register'} className="text-sky-500 text-center ml-2">Sign Up</NavLink>
            </div>
            <form action="" className="mt-5">
                  ...
                  <div className='flex flex-row'>
                  <input type={passwordType} placeholder='Password' className='focus:outline-none w-full mt-5 rounded-l-xl p-3 bg-slate-200 placeholder:text-slate-500 font-extrabold text-slate-900'/>
                  <div className='bg-slate-200 rounded-r-xl mt-5'>
                  ...
                  <div className='flex px-26 mt-6 justify-between items-center'>
                    <button className='bg-slate-200 p-3 mr-10 rounded-xl hover:bg-sky-500 font-extrabold text-slate-400 hover:text-slate-50'>Change method</button>
